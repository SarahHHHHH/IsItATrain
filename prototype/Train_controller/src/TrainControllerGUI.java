...
public class TrainControllerGUI 
{
	...
	private JTextField currentSpeed, currentSpeedLimit, currentAcceleration, currentLight, currentDoor, currentTemp,currentID, currentAuthority;
	...
	setSpeedLabel, setAuthorityLabel, setSpeedLimitLabel, errorReportLabel, setTempLabel, setAnnoucementLabel;
	...
	public double setAuthorityNumber,setAuthorityChange;
	...
	public TrainControllerGUI()
	{
		...
		setTempField=new JTextField("80");
		...
		annoucement.setBounds(100,500,200,300);
	...
	double[] getGUIAuthority()
	{
		double returnValue[]={setAuthorityNumber,setAuthorityChange};
		return returnValue;
	}
	...
	class ButtonListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			else if(e.getSource()==setAuthority)
			{
				...
				{
					tempDouble=Double.valueOf(tempStr);
		            setAuthorityNumber=tempDouble;
		            setAuthorityChange=1.0;
		        }
				catch(Exception ex)
				{
